...
import com.mroyhanadriansyah.adapters.CustomCursorAdapter;
import com.mroyhanadriansyah.adapters.DBHelper;

public class CatatanActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CatatanActivity.this, AddActivity.class));
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long I) {
        ...
        Intent idpinjam = new Intent(CatatanActivity.this, AddActivity.class);
